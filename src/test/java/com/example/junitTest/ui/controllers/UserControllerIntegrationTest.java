...
import com.example.junitTest.security.SecurityConstants;
...
public class UserControllerIntegrationTest {
    ...
    void testCreateUser_whenValidDetailsProvided_returnUserDetails() throws Exception {
        ...
        //act
        ResponseEntity<UserRest> createdUserDetailEntity = testRestTemplate.postForEntity("/users", request, UserRest.class);
        UserRest createdUserDetail = createdUserDetailEntity.getBody();

        //assert
        Assertions.assertEquals(HttpStatus.OK, createdUserDetailEntity.getStatusCode());
        Assertions.assertEquals(userDetailsRequestJson.getString("firstName"), createdUserDetail.getFirstName(),
                "Returned User have firstName not true");
    ...
    @Order(3)
    void testUserLogin_whenValidCredentialsProvided_returnsJWTinAuthorizationHeader() throws Exception {
        // Arrange
